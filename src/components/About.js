    ...
    return (
        <div className="about">
            ...
            <section className="fellow-three">
                ...
                <p>A lifelong gamer, I primarily play on PC and have been an enthusiast of emulation for almost 30 years.</p>
                <p>My path in programming has lead me through a variety of languages, including Python, C#, JS</p>
