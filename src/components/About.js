    ...
    return (
        <div className="about">
            ...
            <section className="fellow-one">
                ...
                <Link to="//github.com/KingAnkoue">
                <img src='https://cdn4.iconfinder.com/data/icons/geomicons/32/672344-github-512.png' alt='github-logo' className='link'/>
                </Link>
            </section>
            <section className="fellow-two">
                ...
                <p>This is who I am...</p>
                <Link to ="//github.com/samfigueroa92">
                    <img src='https://cdn4.iconfinder.com/data/icons/geomicons/32/672344-github-512.png' alt='github-logo' className='link'/>
                </Link>
            </section>
            <section className="fellow-three">
                ...
                <h3>Tom LaTulipe</h3>
                <p>This is who I am...</p>
                <Link to ="//https://github.com/Tetracell">
                <img src='https://cdn4.iconfinder.com/data/icons/geomicons/32/672344-github-512.png' alt='github-logo' className='link'/>
                </Link> 
            </section>
            </div>
